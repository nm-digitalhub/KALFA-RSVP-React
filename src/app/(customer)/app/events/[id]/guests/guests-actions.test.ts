...
// rsvp-links.ts is `server-only`; mock it so importing the action module under
// test doesn't pull the server-only guard into the Node test env.
vi.mock('@/lib/data/rsvp-links', () => ({
