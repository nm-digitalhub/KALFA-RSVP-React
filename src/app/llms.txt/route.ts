...
- [אישורי הגעה לחתונה / RSVP for a wedding](${origin}/wedding)
- [אישורי הגעה לבר מצווה / RSVP for a bar or bat mitzva](${origin}/bar-mitzva)
- [אישורי הגעה לברית / RSVP for a brit](${origin}/brit)
- [אישורי הגעה לאירוע / RSVP for an event or conference](${origin}/event)
- [אישורי הגעה בוואטסאפ / RSVP over WhatsApp](${origin}/whatsapp)
- [תבנית רשימת מוזמנים להורדה / Downloadable guest-list template](${origin}/guest-list-template)
