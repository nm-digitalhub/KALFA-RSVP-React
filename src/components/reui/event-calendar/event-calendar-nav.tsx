...
function EventCalendarNavPrev({
  ...
  return (
    ...
    >
      ...
      >
        {children ?? (
          // KALFA RTL fix: mirror the directional chevron under RTL — "prev"
          // must point toward the past, which is to the RIGHT in Hebrew.
          <ChevronLeftIcon className="size-4 rtl:-scale-x-100" aria-hidden="true" />
        )}
      </Button>
    </NavTooltip>
  )
...
function EventCalendarNavNext({
  ...
  return (
    ...
    >
      ...
      >
        {children ?? (
          // KALFA RTL fix: mirrored under RTL (see NavPrev).
          <ChevronRightIcon className="size-4 rtl:-scale-x-100" aria-hidden="true" />
        )}
      </Button>
    </NavTooltip>
  )
