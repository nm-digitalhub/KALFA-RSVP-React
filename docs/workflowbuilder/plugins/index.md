...
Section titled “What you can do with plugins”
...
Architecture - tech stack, monorepo layout, plugin system, data model
Built-in Nodes - all built-in node types

Some plugins require the Enterprise license. Contact us to request a guided demo or discuss licensing.
