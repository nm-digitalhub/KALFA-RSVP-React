> מקור: https://www.workflowbuilder.io/docs/get-started/quick-start/standalone-app/
> נשמר: 2026-09-09
...
To embed the SDK in your own React app instead, see [React Component](https://www.workflowbuilder.io/docs/get-started/quick-start/wb-as-react-component/).
...
- [React Component](https://www.workflowbuilder.io/docs/get-started/quick-start/wb-as-react-component/). Embed the SDK in your own React app.

- [Node library](https://www.workflowbuilder.io/docs/overview/features/node-library/). Browse, search, and drag nodes from the palette.

- [Add Custom Node Type](https://www.workflowbuilder.io/docs/guides/add-a-custom-node/). Register a new node type with custom properties.
...
- [FAQ](https://www.workflowbuilder.io/docs/faq/). Installation, licensing, and compatibility questions.

[Previous Architecture](https://www.workflowbuilder.io/docs/overview/architecture/)
[Next React Component](https://www.workflowbuilder.io/docs/get-started/quick-start/wb-as-react-component/)
