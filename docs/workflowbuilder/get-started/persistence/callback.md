> מקור: https://www.workflowbuilder.io/docs/get-started/persistence/callback/
> נשמר: 2026-09-09
...
- [localStorage](https://www.workflowbuilder.io/docs/get-started/persistence/localstorage/) — alternative: zero-config persistence with no backend required

- [REST API](https://www.workflowbuilder.io/docs/get-started/persistence/rest-api/) — alternative: server-managed persistence via a REST API
...
[Previous REST API](https://www.workflowbuilder.io/docs/get-started/persistence/rest-api/)
[Next Theming](https://www.workflowbuilder.io/docs/get-started/theming/)
