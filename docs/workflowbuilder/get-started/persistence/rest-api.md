> מקור: https://www.workflowbuilder.io/docs/get-started/persistence/rest-api/
> נשמר: 2026-09-09
...
- The save endpoint needs no extra request shaping (auth, custom payload) — otherwise reach for [`props`](https://www.workflowbuilder.io/docs/get-started/persistence/callback/).

## See also

- [Save diagrams to database](https://www.workflowbuilder.io/docs/guides/save-diagrams-to-database/) — a simple database save example using this strategy

- [via callback](https://www.workflowbuilder.io/docs/get-started/persistence/callback/) — alternative: full control over the request shape (auth, payload transforms)

- [localStorage](https://www.workflowbuilder.io/docs/get-started/persistence/localstorage/) — alternative: zero-config persistence in the browser

- [Configuring the editor](https://www.workflowbuilder.io/docs/guides/configuring-the-editor/) — full reference for `<WorkflowBuilder.Root>` props
...
[Previous localStorage](https://www.workflowbuilder.io/docs/get-started/persistence/localstorage/)
[Next via callback](https://www.workflowbuilder.io/docs/get-started/persistence/callback/)
