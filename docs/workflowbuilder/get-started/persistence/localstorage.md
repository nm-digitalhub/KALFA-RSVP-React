> מקור: https://www.workflowbuilder.io/docs/get-started/persistence/localstorage/
> נשמר: 2026-09-09
...
1. On save — serialise the current diagram to JSON and write it to `localStorage`.
...
- [REST API](https://www.workflowbuilder.io/docs/get-started/persistence/rest-api/) — alternative: persistent, shareable storage via a backend

- [via callback](https://www.workflowbuilder.io/docs/get-started/persistence/callback/) — alternative: full control over loading and saving from your app
...
[Previous React Component](https://www.workflowbuilder.io/docs/get-started/quick-start/wb-as-react-component/)
[Next REST API](https://www.workflowbuilder.io/docs/get-started/persistence/rest-api/)
