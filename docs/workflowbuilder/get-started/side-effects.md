> מקור: https://www.workflowbuilder.io/docs/get-started/side-effects/
> נשמר: 2026-09-09

# Side effects & limitations

What the SDK does to global state on import, and the runtime limits to design around.
...
[Previous Theming](https://www.workflowbuilder.io/docs/get-started/theming/)
[Next Add a custom node](https://www.workflowbuilder.io/docs/guides/add-a-custom-node/)
