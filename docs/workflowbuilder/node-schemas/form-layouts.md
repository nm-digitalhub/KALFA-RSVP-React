...
Layouts are container elements that group child elements into a visual structure. Unlike [controls](https://www.workflowbuilder.io/docs/node-schemas/form-controls/), they don’t bind to a property — they just arrange other elements.
...
- [Form controls](https://www.workflowbuilder.io/docs/node-schemas/form-controls/) — input fields placed inside these layouts
...
- [`UISchema`](https://www.workflowbuilder.io/docs/api/types/uischema/) — auto-generated type reference

[Previous Form controls](https://www.workflowbuilder.io/docs/node-schemas/form-controls/)
[Next Built-in Nodes Overview](https://www.workflowbuilder.io/docs/nodes/)
