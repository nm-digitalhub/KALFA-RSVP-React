> מקור: https://www.workflowbuilder.io/docs/overview/features/diagram-state-management/
> נשמר: 2026-09-09

# Diagram State Management

How Workflow Builder manages canvas state - nodes, edges, undo/redo, and auto-save.
...
The undo/redo stack is powered by the [Undo/Redo plugin](https://www.workflowbuilder.io/docs/plugins/undo-redo/).
...
- [via callback](https://www.workflowbuilder.io/docs/get-started/persistence/callback/) - pass diagram data and save callbacks as React props

- [localStorage](https://www.workflowbuilder.io/docs/get-started/persistence/localstorage/) - persist diagrams to browser localStorage

- [REST API](https://www.workflowbuilder.io/docs/get-started/persistence/rest-api/) - load and save diagrams from a backend REST API

- [Undo / Redo plugin](https://www.workflowbuilder.io/docs/plugins/undo-redo/) - local session history with keyboard shortcuts

[Previous What is Workflow Builder?](https://www.workflowbuilder.io/docs/overview/)
[Next Node Library](https://www.workflowbuilder.io/docs/overview/features/node-library/)
