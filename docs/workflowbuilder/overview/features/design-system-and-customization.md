> מקור: https://www.workflowbuilder.io/docs/overview/features/design-system-and-customization/
> נשמר: 2026-09-09

# Design System & Customization

Workflow Builder's design system - tokens, themes, and how to customize the UI.
...
Workflow Builder ships with a complete default theme, but the underlying components are built with [Overflow UI](https://www.overflow.dev/ui-components/authored/quickstart), a headless (unstyled) React component library. This means you can replace the default styles entirely without fighting against built-in component styles. The visual layer is fully separate from the functional layer.
...
- [Workflow Builder as a React component](https://www.workflowbuilder.io/docs/get-started/quick-start/wb-as-react-component/) - embed Workflow Builder into an existing React app

## References

- [Overflow UI](https://www.overflow.dev/ui-components/authored/quickstart) - the headless React component library underneath the default theme

- [Atomic Design methodology](https://bradfrost.com/blog/post/atomic-web-design/) - the structural model behind the design system

[Previous Properties Sidebar](https://www.workflowbuilder.io/docs/overview/features/properties-sidebar/)
[Next Architecture](https://www.workflowbuilder.io/docs/overview/architecture/)
