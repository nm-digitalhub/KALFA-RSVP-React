> מקור: https://www.workflowbuilder.io/docs/guides/add-a-custom-node/
> נשמר: 2026-09-09
...
Section titled “1. JSON Schema — webhook/schema.ts”
...
Section titled “2. UI Schema — webhook/uischema.ts”
...
Section titled “4. Palette item — webhook/webhook.ts”
...
5. Register the node
Section titled “5. Register the node”
...
Section titled “6. (Optional) Custom renderer”
...
Section titled “7. (Optional) Custom node template”
...
Section titled “Grouping nodes in the palette”
...
Section titled “What’s happening under the hood”
<WorkflowBuilder.Root> receives your props and registers the custom renderer in the JsonForms extension registry plus the nodeTypes array in the palette registry.
When a Webhook node is dropped on the canvas, defaultPropertiesData populates its initial state.
When the node is selected, the property panel renders uischema with JsonForms. Your custom renderer’s tester matches { type: 'ColorPicker' } and wins over the built-in fallback.
Edits flow through handleChange into the diagram model; onDataSave is called when the persistence strategy decides to save.
See also
Section titled “See also”
Node schemas — overview of both halves of a node’s schema
...
Custom JsonForms control — full registry / cell / translation reference
...
- [apps/demo/src/app/data/palette.ts](https://github.com/synergycodes/workflowbuilder/blob/master/apps/demo/src/app/data/palette.ts)
- [apps/demo/src/app/app.tsx](https://github.com/synergycodes/workflowbuilder/blob/master/apps/demo/src/app/app.tsx)
